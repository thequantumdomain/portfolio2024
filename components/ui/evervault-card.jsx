    ...
    return (
        ...
        >
            <div
                ...
                className="group/card w-full relative overflow-hidden bg-transparent flex items-center justify-center h-full rounded-full"
            >
                <CardPattern
                    mouseX={mouseX}
                    mouseY={mouseY}
                ...
                <div className="relative z-10 flex items-center justify-center">
                    <div className="relative flex items-center justify-center text-white font-bold text-4xl">
                        ...
                        <span className="dark:text-white text-black z-20 px-4 py-2">
                            {text}
                        </span>
                    </div>
                </div>
